...
source_id: SRC-NC-V12A-ncmsg-jmp0600-jmp0699
title: JMP0600－JMP0699（4.8） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0600－JMP0699（4.8） — メッセージ集 V12.2

## Summary
Dải mã message JMP0600-JMP0699 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.8.
...
- Section 4.8 «JMP0600－JMP0699» trong NetCOBOL V12.2 メッセージ集.md.
