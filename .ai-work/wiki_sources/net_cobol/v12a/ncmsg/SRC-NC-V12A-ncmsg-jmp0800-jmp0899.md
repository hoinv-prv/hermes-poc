...
source_id: SRC-NC-V12A-ncmsg-jmp0800-jmp0899
title: JMP0800－JMP0899（4.10） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0800－JMP0899（4.10） — メッセージ集 V12.2

## Summary
Dải mã message JMP0800-JMP0899 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.10.
...
- Section 4.10 «JMP0800－JMP0899» trong NetCOBOL V12.2 メッセージ集.md.
