...
source_id: SRC-NC-V12A-ncmsg-jmp0300-jmp0399
title: JMP0300－JMP0399（4.6） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0300－JMP0399（4.6） — メッセージ集 V12.2

## Summary
Dải mã message JMP0300-JMP0399 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.6.
...
- Section 4.6 «JMP0300－JMP0399» trong NetCOBOL V12.2 メッセージ集.md.
