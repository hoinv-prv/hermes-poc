...
source_id: SRC-NC-V12A-ncmsg-jmn9000-jmn9999
title: JMN9000－JMN9999（2.8） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMN9000－JMN9999（2.8） — メッセージ集 V12.2

## Summary
Dải mã message JMN9000-JMN9999 (翻訳時/compile-time) — struct meta; mỗi code cụ thể tra demand-driven trong section 2.8.
...
- Section 2.8 «JMN9000－JMN9999» trong NetCOBOL V12.2 メッセージ集.md.
