...
source_id: SRC-NC-V12A-ncmsg-odbc
title: ODBC（2.9） — メッセージ集 V12.2
...
---
# Wiki Source Meta — ODBC（2.9） — メッセージ集 V12.2

## Summary
Dải mã message ODBC (翻訳時/compile-time) — struct meta; mỗi code cụ thể tra demand-driven trong section 2.9.
...
- Section 2.9 «ODBC» trong NetCOBOL V12.2 メッセージ集.md.
