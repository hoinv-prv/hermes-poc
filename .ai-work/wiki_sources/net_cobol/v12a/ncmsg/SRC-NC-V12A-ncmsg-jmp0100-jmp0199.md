...
source_id: SRC-NC-V12A-ncmsg-jmp0100-jmp0199
title: JMP0100－JMP0199（4.4） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0100－JMP0199（4.4） — メッセージ集 V12.2

## Summary
Dải mã message JMP0100-JMP0199 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.4.
...
- Section 4.4 «JMP0100－JMP0199» trong NetCOBOL V12.2 メッセージ集.md.
