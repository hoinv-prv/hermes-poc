...
source_id: SRC-NC-V12A-ncmsg-jmn1000-jmn1999
title: JMN1000－JMN1999（2.3） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMN1000－JMN1999（2.3） — メッセージ集 V12.2

## Summary
Dải mã message JMN1000-JMN1999 (翻訳時/compile-time) — struct meta; mỗi code cụ thể tra demand-driven trong section 2.3.
...
- Section 2.3 «JMN1000－JMN1999» trong NetCOBOL V12.2 メッセージ集.md.
