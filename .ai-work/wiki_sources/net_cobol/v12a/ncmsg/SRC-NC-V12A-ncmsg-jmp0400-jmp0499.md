...
source_id: SRC-NC-V12A-ncmsg-jmp0400-jmp0499
title: JMP0400－JMP0499（4.7） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0400－JMP0499（4.7） — メッセージ集 V12.2

## Summary
Dải mã message JMP0400-JMP0499 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.7.
...
- Section 4.7 «JMP0400－JMP0499» trong NetCOBOL V12.2 メッセージ集.md.
