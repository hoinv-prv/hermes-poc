...
source_id: SRC-NC-V12A-ncmsg-jmn2000-jmn2999
title: JMN2000－JMN2999（2.4） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMN2000－JMN2999（2.4） — メッセージ集 V12.2

## Summary
Dải mã message JMN2000-JMN2999 (翻訳時/compile-time) — struct meta; mỗi code cụ thể tra demand-driven trong section 2.4.
...
- Section 2.4 «JMN2000－JMN2999» trong NetCOBOL V12.2 メッセージ集.md.
