...
source_id: SRC-NC-V12A-ncmsg-jmp0900-jmp0999
title: JMP0900－JMP0999（4.11） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0900－JMP0999（4.11） — メッセージ集 V12.2

## Summary
Dải mã message JMP0900-JMP0999 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.11.
...
- Section 4.11 «JMP0900－JMP0999» trong NetCOBOL V12.2 メッセージ集.md.
