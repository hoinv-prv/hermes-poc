...
source_id: SRC-NC-V12A-ncmsg-jmp0000-jmp0099
title: JMP0000－JMP0099（4.3） — メッセージ集 V12.2
...
---
# Wiki Source Meta — JMP0000－JMP0099（4.3） — メッセージ集 V12.2

## Summary
Dải mã message JMP0000-JMP0099 (実行時/runtime) — struct meta; mỗi code cụ thể tra demand-driven trong section 4.3.
...
- Section 4.3 «JMP0000－JMP0099» trong NetCOBOL V12.2 メッセージ集.md.
