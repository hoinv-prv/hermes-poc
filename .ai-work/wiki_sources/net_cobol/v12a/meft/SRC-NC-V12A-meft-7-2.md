...
source_id: SRC-NC-V12A-meft-7-2
title: 7.2 C言語による記述 — MeFt V12.2
...
---
# Wiki Source Meta — 7.2 C言語による記述 — MeFt V12.2

## Summary
C言語による記述 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.2 C言語による記述» — page 227 trong MeFt V12.2 ユーザーズガイド.md.
