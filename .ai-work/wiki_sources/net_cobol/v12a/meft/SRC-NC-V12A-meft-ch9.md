...
source_id: SRC-NC-V12A-meft-ch9
title: 第9章 プリンタ情報ファイル — MeFt V12.2
...
---
# Wiki Source Meta — 第9章 プリンタ情報ファイル — MeFt V12.2

## Summary
プリンタ情報ファイル — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第9章 プリンタ情報ファイル» — page 371 trong MeFt V12.2 ユーザーズガイド.md.
