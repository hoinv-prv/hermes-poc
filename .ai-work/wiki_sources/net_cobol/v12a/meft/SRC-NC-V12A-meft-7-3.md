...
source_id: SRC-NC-V12A-meft-7-3
title: 7.3 基本処理 — MeFt V12.2
...
---
# Wiki Source Meta — 7.3 基本処理 — MeFt V12.2

## Summary
基本処理 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.3 基本処理» — page 232 trong MeFt V12.2 ユーザーズガイド.md.
