...
source_id: SRC-NC-V12A-meft-ch10
title: 第10章 サポート状況 — MeFt V12.2
...
---
# Wiki Source Meta — 第10章 サポート状況 — MeFt V12.2

## Summary
サポート状況 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第10章 サポート状況» — page 433 trong MeFt V12.2 ユーザーズガイド.md.
