...
source_id: SRC-NC-V12A-meft-ch3
title: 第3章 開発と運用 — MeFt V12.2
...
---
# Wiki Source Meta — 第3章 開発と運用 — MeFt V12.2

## Summary
開発と運用 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第3章 開発と運用» — page 32 trong MeFt V12.2 ユーザーズガイド.md.
