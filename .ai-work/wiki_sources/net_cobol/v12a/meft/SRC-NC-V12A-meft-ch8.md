...
source_id: SRC-NC-V12A-meft-ch8
title: 第8章 ウィンドウ情報ファイル — MeFt V12.2
...
---
# Wiki Source Meta — 第8章 ウィンドウ情報ファイル — MeFt V12.2

## Summary
ウィンドウ情報ファイル — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第8章 ウィンドウ情報ファイル» — page 309 trong MeFt V12.2 ユーザーズガイド.md.
