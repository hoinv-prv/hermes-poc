...
source_id: SRC-NC-V12A-meft-7-8
title: 7.8 通知コード — MeFt V12.2
...
---
# Wiki Source Meta — 7.8 通知コード — MeFt V12.2

## Summary
通知コード — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.8 通知コード» — page 283 trong MeFt V12.2 ユーザーズガイド.md.
