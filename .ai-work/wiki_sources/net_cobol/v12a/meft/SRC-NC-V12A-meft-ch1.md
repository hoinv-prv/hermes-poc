...
source_id: SRC-NC-V12A-meft-ch1
title: 第1章 MeFtの概要 — MeFt V12.2
...
---
# Wiki Source Meta — 第1章 MeFtの概要 — MeFt V12.2

## Summary
MeFtの概要 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第1章 MeFtの概要» — page 18 trong MeFt V12.2 ユーザーズガイド.md.
