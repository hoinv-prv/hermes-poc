...
source_id: SRC-NC-V12A-meft-ch11
title: 第11章 ログ機能 — MeFt V12.2
...
---
# Wiki Source Meta — 第11章 ログ機能 — MeFt V12.2

## Summary
ログ機能 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第11章 ログ機能» — page 455 trong MeFt V12.2 ユーザーズガイド.md.
