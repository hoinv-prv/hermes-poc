...
source_id: SRC-NC-V12A-meft-ch7
title: 第7章 プログラムインタフェース — MeFt V12.2
...
---
# Wiki Source Meta — 第7章 プログラムインタフェース — MeFt V12.2

## Summary
プログラムインタフェース — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第7章 プログラムインタフェース» — page 225 trong MeFt V12.2 ユーザーズガイド.md.
