...
source_id: SRC-NC-V12A-meft-7-5
title: 7.5 画面制御 — MeFt V12.2
...
---
# Wiki Source Meta — 7.5 画面制御 — MeFt V12.2

## Summary
画面制御 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.5 画面制御» — page 259 trong MeFt V12.2 ユーザーズガイド.md.
