...
source_id: SRC-NC-V12A-meft-ch4
title: 第4章 画面機能 — MeFt V12.2
...
---
# Wiki Source Meta — 第4章 画面機能 — MeFt V12.2

## Summary
画面機能 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «第4章 画面機能» — page 79 trong MeFt V12.2 ユーザーズガイド.md.
