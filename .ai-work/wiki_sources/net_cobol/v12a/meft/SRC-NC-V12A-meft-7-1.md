...
source_id: SRC-NC-V12A-meft-7-1
title: 7.1 プログラムインタフェース一覧 — MeFt V12.2
...
---
# Wiki Source Meta — 7.1 プログラムインタフェース一覧 — MeFt V12.2

## Summary
プログラムインタフェース一覧 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.1 プログラムインタフェース一覧» — page 225 trong MeFt V12.2 ユーザーズガイド.md.
