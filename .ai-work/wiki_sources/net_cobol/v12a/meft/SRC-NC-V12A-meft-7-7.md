...
source_id: SRC-NC-V12A-meft-7-7
title: 7.7 その他の関数 — MeFt V12.2
...
---
# Wiki Source Meta — 7.7 その他の関数 — MeFt V12.2

## Summary
その他の関数 — đơn vị MeFt V12.2 (帳票/display/SORT). Backing reference cho conversion/review ASP COBOL → NetCOBOL (Tier B, L2/L3 selective); KHÔNG duplicate migration_policy.
...
- «7.7 その他の関数» — page 279 trong MeFt V12.2 ユーザーズガイド.md.
